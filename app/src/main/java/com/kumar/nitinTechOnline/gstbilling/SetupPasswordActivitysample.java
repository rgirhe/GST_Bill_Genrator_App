...
public class SetupPasswordActivitysample extends SetupPasswordActivity {
    ...
    public void onClick1(View v) {
        ...
        if (newPassword.equals(confirmPassword)) {
            SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(SetupPasswordActivitysample.this);
            ...
            startActivity(new Intent(SetupPasswordActivitysample.this, BillsActivity.class));
